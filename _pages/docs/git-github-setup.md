...
Аналогичным образом будет выполняться и оповещение о проверке.
...
А чтобы посмотреть все файлы с проверкой, надо нажать browse (репозиторий перейдет в корневой каталог и оттуда можно будет перейти к нужному разделу).
