...
> ```..origin/master``` в этой команде означает показать все коммиты, которые есть в origin/master - в данном случае, это GitHub, но которых нет в ваашей локальной копии репозитория.
