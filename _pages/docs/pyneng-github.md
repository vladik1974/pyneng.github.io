...
В [репозитории курса](https://github.com/pyneng/pyneng-online-jun-oct-2018) выложены задания и примеры, которые будут рассматриваться на курсе.
...
```
$ git clone https://github.com/pyneng/pyneng-online-jun-oct-2018
Cloning into 'pyneng-online-jun-oct-2018'...
...
При необходимости обновить локальную версию репозитория, чтобы синхронизировать её с версией на GitHub, надо выполнить git pull внутри созданного каталога pyneng-online-jun-oct-2018.

Если обновлений не было, вывод будет таким:
```
$ cd pyneng-online-jun-oct-2018/
...
From https://github.com/pyneng/pyneng-online-jun-oct-2018
...
+++ b/README.md
@@ -7,5 +7,5 @@
 * [exercises](https://github.com/pyneng/pyneng-online-jun-oct-2018/tree/master/exercises) - домашние задания
 * [study](https://github.com/pyneng/pyneng-online-jun-oct-2018/tree/master/study) - ссылки и документы по обучению
-* [tools](https://github.com/pyneng/pyneng-online-jun-oct-2018/tree/master/tools) - howto по использованию инструментов курса (будут позже)
+* [tools](https://github.com/pyneng/pyneng-online-jun-oct-2018/tree/master/tools) - PDF версии howto по использованию инструментов курса (будут позже)
```
